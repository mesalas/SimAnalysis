...
class MyTestCase(unittest.TestCase):
    ...
    def test_make_bars(self):
        ...
        outputs = ["testing/test_data/reduced_data/0_ABC_bars_1T.csv.gz",
                   "testing/test_data/reduced_data/0_DEF_bars_1T.csv.gz",
                   "testing/test_data/reduced_data/0_GHI_bars_1T.csv.gz"]

        [make_trade_bars.make_trade_bars(input_file, "1T", output_file) for input_file,output_file in zip(inputs,outputs)]
